import { c as createDenunciasActor, r as reactExports, j as jsxRuntimeExports, B as Badge, X, S as Shield, E as ExternalLink, G as Globe, a as Button, b as Search, C as ChevronUp, d as ChevronDown, M as MapContainer, T as TileLayer, e as CircleMarker, P as Popup, u as useMap, f as useFraudData, g as getReportsByLocation, h as Card, i as CardContent, k as CardHeader, l as CardTitle, L as LegalDisclaimerBanner, D as Dialog, m as DialogContent, n as DialogHeader, o as DialogTitle, p as Textarea, q as DialogFooter } from "./index-C67edjsn.js";
const CANISTERS = {
  principal: {
...
async function pingCanister(canisterId) {
...
async function fetchCanisterReports() {
  try {
...
const STATUS_CHECK_INTERVAL_MS = 6e4;
function useCanisterSync() {
  ...
  const reportTimerRef = reactExports.useRef(null);
  const statusTimerRef = reactExports.useRef(null);
  const syncStatuses = reactExports.useCallback(async () => {
    const results = await checkAllCanisters();
    setStatuses(results);
  }, []);
  const syncReports = reactExports.useCallback(async () => {
...
function healthDot(healthStatus, online) {
...
function healthLabel(healthStatus, online) {
  const status = healthStatus ?? (online ? "online" : "offline");
...
function CanisterStatusPanel() {
  const { statuses, loading, lastSync, onlineCount, totalCount, syncStatuses } = useCanisterSync();
  const [expanded, setExpanded] = reactExports.useState(false);
  const installingCount = statuses.filter(
    (s) => s.healthStatus === "installing"
  ).length;
  const allOnline = onlineCount === totalCount && totalCount > 0;
  const someIssue = installingCount > 0 || onlineCount < totalCount;
  const overallColor = loading ? "bg-yellow-500" : allOnline ? "bg-green-500" : installingCount > 0 ? "bg-yellow-500" : someIssue ? "bg-yellow-500" : "bg-red-500";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-slate-700 bg-slate-900/90 text-white text-sm shadow-lg overflow-hidden", children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold tracking-wide", children: "ICP Canisters" }),
            !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-400", children: [
              onlineCount,
              "/",
              totalCount,
              " online",
              installingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-yellow-400", children: [
                "· ",
                installingCount,
                " a instalar"
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            lastSync && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-500 hidden sm:inline", children: [
              "Sync: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500 text-xs", children: expanded ? "▲" : "▼" })
          ] })
        ]
      }
    ),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-slate-700 divide-y divide-slate-800", children: [
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 text-slate-400 text-xs", children: "A verificar canisters..." }) : statuses.map((s) => {
        const hs = s.healthStatus;
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-xs", children: s.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-500 text-xs font-mono", children: s.id })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-semibold ${lbl.cls}`, children: lbl.text }),
                s.latencyMs !== void 0 && s.online && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-slate-500", children: [
                  s.latencyMs,
                  "ms"
                ] }),
                hs === "installing" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-yellow-600", children: "instalar Motoko via dfx" })
              ] })
            ]
          },
          s.id
      ...
      installingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2.5 bg-yellow-950/40 border-t border-yellow-800", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-300 font-medium", children: "⟳ Canisters em 503 aguardam instalação do código Motoko." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-yellow-600 mt-0.5", children: [
          "Execute:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "dfx deploy --network ic" }),
          " com o teu controller."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-600", children: "Quando o deploy terminar, o estado ficará verde automaticamente." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 bg-slate-950/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-600 font-mono", children: "Controller: 6wzpv-jfxnt-kzbeg-4isuv-vd2m2-yfzmk-znnho-tpvrg-lmarn-afsnw-tae" }) })
    ] })
  ] });
}
...
function FraudDetailModal({ report, onClose }) {
  if (!report) return null;
  const explorerUrl = report.type === "Crypto" ? "https://etherscan.io" : "https://www.phishtank.com";
  const explorerLabel = report.type === "Crypto" ? "Etherscan" : "PhishTank";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: report && /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between p-5 pb-3 border-b border-gray-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl leading-none", children: TYPE_ICONS[report.type] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: PERIOD_LABELS[report.period] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4 text-gray-500" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base w-5 flex-shrink-0", children: "📅" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs uppercase tracking-wide font-semibold block", children: "Data" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-800 font-medium", children: formatDate(report.timestamp) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base w-5 flex-shrink-0", children: "📍" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs uppercase tracking-wide font-semibold block", children: "Local" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-800 font-medium", children: [
                    report.city,
                    ", ",
                    report.country,
                    " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base w-5 flex-shrink-0", children: "⚠️" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs uppercase tracking-wide font-semibold block", children: "Score de Risco" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      ...
                      children: [
                        report.score,
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-normal text-gray-400", children: "/99" })
                      ]
                    }
                  )
                ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-50 rounded-xl p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-blue-600 font-semibold uppercase tracking-wide", children: "Confiança" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-bold text-blue-700", children: [
                    report.confidence,
                    "%"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-blue-400 mt-0.5", children: "AbuseIPDB + OTX" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 rounded-xl p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5 text-green-600" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-green-600 font-semibold uppercase tracking-wide", children: "Fontes" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-green-700", children: report.sources }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-green-400 mt-0.5", children: "bases públicas" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base w-5 flex-shrink-0", children: "💬" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs uppercase tracking-wide font-semibold block mb-1", children: "Resumo" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-700 text-sm leading-relaxed bg-gray-50 rounded-lg px-3 py-2", children: [
                    '"',
                    report.summary,
                    '"'
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: "🔗" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 font-semibold", children: "Verificar:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: explorerUrl,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 pt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-gray-400 bg-gray-50 rounded-lg p-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-3 h-3 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Dados agregados públicos — Apenas IPs públicos e scores agregados — Sem identificação pessoal — GDPR compliant" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
...
function generateFraudData() {
  ...
  for (const cityDef of CITY_DATA) {
    for (let i = 0; i < cityDef.density; i++) {
      ...
      if (rnd < 0.15) {
        period = "24h";
        ageMs = Math.random() * 23 * 36e5;
      } else if (rnd < 0.4) {
        period = "7d";
        ageMs = 24 * 36e5 + Math.random() * 6 * 24 * 36e5;
      } else if (rnd < 0.65) {
        period = "30d";
        ageMs = 7 * 24 * 36e5 + Math.random() * 23 * 24 * 36e5;
      } else {
        period = "historical";
        ageMs = 30 * 24 * 36e5 + Math.random() * 335 * 24 * 36e5;
      }
...
function FraudHeatmap() {
  ...
  const [regionFilters, setRegionFilters] = reactExports.useState(new Set(ALL_REGIONS.map((r) => r.code)));
  const [showFilters, setShowFilters] = reactExports.useState(false);
  const [cityQuery, setCityQuery] = reactExports.useState("");
  const [selectedCity, setSelectedCity] = reactExports.useState(null);
  const [mapTarget, setMapTarget] = reactExports.useState(null);
  ...
  const cityCount = selectedCity ? visibleReports.filter(
    (r) => r.city.toLowerCase() === selectedCity.toLowerCase()
  ).length : null;
  const handleCitySearch = reactExports.useCallback((rawCity) => {
    ...
    if (coords) {
      ...
      const partial = Object.keys(CITY_COORDS).find(
        (k) => k.toLowerCase().includes(trimmed.toLowerCase())
      );
      if (partial) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-slate-800 to-slate-900 text-white rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", children: globalCount.toLocaleString("pt-PT") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-300 mt-0.5", children: "🌍 Global" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-green-700 to-green-800 text-white rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", children: ptCount.toLocaleString("pt-PT") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-200 mt-0.5", children: "🇵🇹 Portugal" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-yellow-600 to-yellow-700 text-white rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", children: brCount.toLocaleString("pt-PT") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-yellow-100 mt-0.5", children: "🇧🇷 Brasil" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-blue-700 to-blue-800 text-white rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", children: euCount.toLocaleString("pt-PT") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-blue-200 mt-0.5", children: "🇪🇺 Europa" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-gray-400 mt-1", children: "⚖️ Fonte: AbuseIPDB · OTX AlienVault · Comunidade ICP — GDPR compliant" }),
    selectedCity && cityCount !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm font-semibold text-foreground bg-amber-50 border border-amber-200 rounded-lg px-3 py-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-1.5", children: ["24h", "7d", "30d", "historical"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: p === "24h" ? count24h.toLocaleString("pt-PT") : p === "7d" ? count7d.toLocaleString("pt-PT") : p === "30d" ? count30d.toLocaleString("pt-PT") : countHistorical.toLocaleString("pt-PT")
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] mt-0.5 opacity-80", children: p === "24h" ? "🔴 24h" : p === "7d" ? "🟠 7 dias" : p === "30d" ? "🟡 30 dias" : "🔵 Histórico" })
        ]
      },
      p
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: PRESET_CITIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-xl overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "⚙️ Filtros" }),
            showFilters ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4" })
          ]
        }
      ),
      showFilters && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-3 bg-white border-t border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Tipo de Fraude" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: ALL_TYPES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Região" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: ALL_REGIONS.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              className: "flex items-center gap-1.5 cursor-pointer select-none",
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Período" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: [
            ...
            "button",
            {
              ...
              className: `px-3 py-1 text-xs font-semibold rounded-full border transition ${periodFilter === value ? "bg-slate-800 text-white border-slate-800" : "bg-white text-gray-600 border-gray-300 hover:border-gray-400"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        visibleReports.length.toLocaleString("pt-PT"),
        " ocorrências visíveis"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Clique num pin para detalhes" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          MapContainer,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapController, { target: mapTarget }),
              visibleReports.map((report) => {
                const color2 = PERIOD_COLOR[report.period];
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleMarker,
                  {
                    ...
                    pathOptions: {
                      fillColor: color2,
                      color: isRecent ? "#fff" : color2,
                      weight: isRecent ? 2 : 1,
                      opacity: 0.95,
                      fillOpacity: isRecent ? 0.92 : 0.65
                    },
                    eventHandlers: { click: () => setSelectedReport(report) },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Popup, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minWidth: 200, fontSize: 13, lineHeight: 1.6 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                      ...
                      report.summary && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4 justify-center text-xs text-muted-foreground", children: ["24h", "7d", "30d", "historical"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      p === "24h" ? "🔴 24h" : p === "7d" ? "🟠 7 dias" : p === "30d" ? "🟡 30 dias" : "🔵 Histórico"
    ] }, p)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground text-center leading-relaxed", children: "⚖️ Dados agregados públicos — Apenas IPs públicos e scores agregados — Sem identificação pessoal — GDPR compliant" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FraudDetailModal,
      {
...
async function fetchFraudPoints() {
...
function deduplicateById(points) {
...
const REGIONS = ["Todas", "Europa", "Américas", "Ásia/África"];
const REGION_VIEWS = {
...
function computeStats(data) {
  ...
  const top3Countries = Object.entries(byCountry).sort((a, b) => b[1] - a[1]).slice(0, 3);
  const top2Types = Object.entries(byType).sort((a, b) => b[1] - a[1]).slice(0, 2);
...
function FraudRadarPage() {
  const [activeRegion, setActiveRegion] = reactExports.useState("Todas");
  const [fraudPoints, setFraudPoints] = reactExports.useState([]);
  const {
  ...
  const [reportModalOpen, setReportModalOpen] = reactExports.useState(false);
  const [reportReason, setReportReason] = reactExports.useState("");
  const [reportType, setReportType] = reactExports.useState("Telefone");
  const [reportValue, setReportValue] = reactExports.useState("");
  const [reportSuccess, setReportSuccess] = reactExports.useState(false);
  ...
  const communityFraudData = hasCommunityData ? Object.values(communityLocations).map((loc) => ({
    lat: loc.lat,
    lng: loc.lng,
    city: loc.city,
    country: loc.country,
  ...
  const canisterPoints = canisterReports.map((r) => ({
    lat: Number(r.lat),
    lng: Number(r.lon),
    type: r.reportType,
    country: r.country,
  ...
  const allFraudPoints = [...fraudPoints, ...canisterPoints];
  const allDataForStats = [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-foreground", children: "📡 Radar Global de Fraudes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 bg-green-100 text-green-700 text-xs font-semibold px-2.5 py-1 rounded-full border border-green-300", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-500 animate-pulse" }),
                "Tempo Real"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Monitorização das fraudes reportadas pela comunidade" }),
            lastSync && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Última sincronização: ",
              lastSync.toLocaleTimeString("pt-PT"),
              canisterPoints.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-green-600 font-medium", children: [
                "+",
                canisterPoints.length,
                " do canister"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CanisterStatusPanel, {}),
          errorKind === "installing" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-4 rounded-xl border border-yellow-500 bg-yellow-950/30 text-yellow-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl mt-0.5", children: "⏳" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-yellow-300 text-sm", children: "A instalar Motoko no canister 7w5qg-6aaaa-aaaab-ael4a-cai" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-400", children: "O canister está ativo mas aguarda o deploy do código Motoko. O Radar Global funciona com dados AbuseIPDB + OTX enquanto isso. Quando o deploy terminar, os dados do canister aparecem automaticamente." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-yellow-600 font-mono mt-1", children: "dfx deploy denuncias --network ic" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FraudHeatmap, {}) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider", children: "Denúncias da Comunidade" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
          ] }),
          viralCity && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "ALERTA VIRAL: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: viralCity.city }),
                  " atingiu",
                  " ",
                  viralCity.count,
                  " denúncias — fraude em rápida expansão"
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "📊 Estatísticas Globais" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-foreground", children: stats.total.toLocaleString("pt-PT") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Pontos de fraude globais" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Top 3 Países" }),
                  stats.top3Countries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "A carregar..." }) : stats.top3Countries.map(([country, count], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: count })
                      ]
                    },
                    country
                  ))
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2", children: "Top 2 Tipos" }),
                  stats.top2Types.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "A carregar..." }) : stats.top2Types.map(([type, count]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex justify-between text-sm py-0.5",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: type }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: count })
                      ]
                    },
                    type
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base", children: [
              ...
              allFraudPoints.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-xs font-normal text-muted-foreground", children: [
                "(",
                allFraudPoints.length,
                " pontos)"
              ] })
            ] }) }),
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  MapContainer,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(RegionController, { region: activeRegion }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        TileLayer,
                        {
                          url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
                      ...
                      communityFraudData.map((d) => {
                        ...
                        const color2 = d.count > 60 ? "#dc2626" : d.count > 30 ? "#ea580c" : "#f59e0b";
                        return /* @__PURE__ */ jsxRuntimeExports.jsx(
                          CircleMarker,
                          {
                            center: [d.lat, d.lng],
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Popup, { children: [
                              ...
                              " denúncias",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: d.type }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: d.country || "" })
                            ] })
                          },
                          `comm-${d.lat}-${d.lng}`
                        );
                      ...
                      allFraudPoints.map((p, idx) => {
                        const color2 = p.score >= 70 ? "#dc2626" : p.score >= 40 ? "#f59e0b" : "#9ca3af";
                        return /* @__PURE__ */ jsxRuntimeExports.jsx(
                          CircleMarker,
                          {
                            center: [p.lat, p.lng],
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Popup, { children: [
                              ...
                              "/99",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: p.type }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: p.country }),
                              p.source && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "text-blue-600", children: p.source })
                              ] })
                            ] })
                          },
                          `fp-${p.lat}-${p.lng}-${idx}`
            ...
            !hasCommunityData && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "p-4 border-t border-border text-center space-y-2",
                "data-ocid": "fraud-radar.empty_state",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "⏳ A carregar dados globais de fraude…" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Os dados do mapa serão atualizados automaticamente com novas denúncias." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: "🚨 Reportar Fraude"
                    }
                  )
                ]
              }
            ),
            hasCommunityData && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-border text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                onClick: () => setReportModalOpen(true),
                size: "sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2", children: sortedByCount.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm text-muted-foreground text-center py-4",
                "data-ocid": "fraud-radar.list.empty_state",
                children: "Sem denúncias registadas ainda."
              }
            ) : sortedByCount.slice(0, 10).map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium", children: d.city }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      variant: "outline",
                      className: d.count > 60 ? "border-red-400 text-red-700 bg-red-50 text-[10px]" : d.count > 30 ? "border-orange-400 text-orange-700 bg-orange-50 text-[10px]" : "border-amber-400 text-amber-700 bg-amber-50 text-[10px]",
                      children: [
                        d.count,
                        " denúncias"
                      ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(LegalDisclaimerBanner, { variant: "full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: reportModalOpen, onOpenChange: handleReportClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "flex items-center gap-2", children: "🚨 Reportar Fraude" }) }),
          reportSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-6 text-center space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: "✅" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-700 font-semibold", children: "Denúncia registada com sucesso" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "A sua denúncia foi guardada e contribui para o radar global de fraudes." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleReportClose, className: "w-full", children: "Fechar" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Tipo de fraude" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    value: reportType,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Telefone" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Email" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Link / URL" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "IBAN" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Cripto" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { children: "Mensagem SMS/WhatsApp" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Número / valor a reportar" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Motivo da denúncia" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-gray-400 bg-gray-50 rounded p-2 border", children: [
              "⚖️ ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Aviso Legal:" }),
              " A AntiFraudapp não é autoridade oficial. As denúncias são da exclusiva responsabilidade do utilizador."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: reportSubmitting ? "A guardar…" : "Confirmar Denúncia"
                }
              )
            ] })
          ] })
