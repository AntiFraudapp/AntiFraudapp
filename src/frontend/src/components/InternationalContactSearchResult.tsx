/**
 * International contact search result card.
...
export interface InternationalContactResult {
...
interface Props {
  result: InternationalContactResult;
  onReport?: () => void;
}
...
export function InternationalContactSearchResult({ result, onReport }: Props) {
...
export default InternationalContactSearchResult;
